/**
    ...
    *Note*
    This implementation came up from www.google.com/search?q=DileptonAnalyticalSolver
    There is no indication about the permission/copyright.
    I am now using it just as a test, and I might re-implement it once
    I have evaluated the various methods available on the market.
    (davide.gerbaudo@gmail.com, Mar2013)
