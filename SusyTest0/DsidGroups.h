...
// This header was generated by print_group_header.py on 2014-03-09 03:28:07.631560
...
const size_t kNdsidForkTriboson  = sizeof(kDsidForkTriboson)/sizeof(kDsidForkTriboson[0]);
const size_t kNdsidForkTtbarZ  = sizeof(kDsidForkTtbarZ)/sizeof(kDsidForkTtbarZ[0]);
const size_t kNdsidForkZz  = sizeof(kDsidForkZz)/sizeof(kDsidForkZz[0]);
const size_t kNdsidForkHiggs  = sizeof(kDsidForkHiggs)/sizeof(kDsidForkHiggs[0]);
const size_t kNdsidForkTtbar  = sizeof(kDsidForkTtbar)/sizeof(kDsidForkTtbar[0]);
const size_t kNdsidForkZjets  = sizeof(kDsidForkZjets)/sizeof(kDsidForkZjets[0]);
const size_t kNdsidForkTtbarW  = sizeof(kDsidForkTtbarW)/sizeof(kDsidForkTtbarW[0]);
const size_t kNdsidForkWwjj  = sizeof(kDsidForkWwjj)/sizeof(kDsidForkWwjj[0]);
const size_t kNdsidForkWw  = sizeof(kDsidForkWw)/sizeof(kDsidForkWw[0]);
const size_t kNdsidForkWz  = sizeof(kDsidForkWz)/sizeof(kDsidForkWz[0]);
const size_t kNdsidForkSingleTop  = sizeof(kDsidForkSingleTop)/sizeof(kDsidForkSingleTop[0]);
