...
void SusySelection::dumpEventCounters()
{
  ...
  for(int w=0; w<WT_N; ++w){
    ...
    cout<<midRule                                                         <<endl;
    cout<<"read in:              : "<<setw(cw)<<n_readin           [w]              <<endl;
    cout<<"pass GRL              : "<<setw(cw)<<n_pass_Grl         [w]              <<endl;
    cout<<"pass LarErr           : "<<setw(cw)<<n_pass_LarErr      [w]              <<endl;
    cout<<"pass TileErr          : "<<setw(cw)<<n_pass_TileErr     [w]              <<endl;
    cout<<"pass TTCVeto          : "<<setw(cw)<<n_pass_TTCVeto     [w]              <<endl;
    cout<<"pass GoodVtx          : "<<setw(cw)<<n_pass_GoodVtx     [w]              <<endl;
    cout<<"pass TileTripCut      : "<<setw(cw)<<n_pass_TileTrip    [w]              <<endl;
    cout<<"pass LAr:             : "<<setw(cw)<<n_pass_LAr         [w]              <<endl;
    cout<<"pass BadJet:          : "<<setw(cw)<<n_pass_BadJet      [w]              <<endl;
    cout<<"pass FEB:             : "<<setw(cw)<<n_pass_FEBCut      [w]              <<endl;
